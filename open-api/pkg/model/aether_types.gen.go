...
type ConnectivityServices struct {
	...
	ConnectivityService  *ConnectivityServicesConnectivityServiceList `json:"connectivity-service,omitempty" gorm:"foreignKey:ConnectivityServicesConnectivityService"`
...
type ConnectivityServicesConnectivityService struct {
	...
	ConnectivityServiceId string `json:"connectivity-service-id" gorm:"primary_key"`
...
type EnterprisesEnterpriseSiteSimCard struct {
	...
	// IPAddress mapping for this sim card
